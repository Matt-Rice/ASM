...
public class gen2backup{
    ...
    public static void main(String[] args){
        ...
        // MethodVisitor for subtracting doubles
        {
         ...
         // MethodVisitor for subtracting longs
         {
        ...
        // MethodVisitor for subtracting Integers
        {
        ...
        }
        {
            ...
            mv.visitMethodInsn(Opcodes.INVOKESTATIC, "program2", "subtractDouble", "()V", false);
            
            mv.visitFieldInsn(Opcodes.GETSTATIC, "java/lang/System", "out", "Ljava/io/PrintStream;");
            mv.visitLdcInsn("Subtracting longs:");
            mv.visitMethodInsn(Opcodes.INVOKEVIRTUAL, "java/io/PrintStream", "println", "(Ljava/lang/String;)V", false);
            mv.visitMethodInsn(Opcodes.INVOKESTATIC, "program2", "subtractLong", "()V", false);
           
            mv.visitFieldInsn(Opcodes.GETSTATIC, "java/lang/System", "out", "Ljava/io/PrintStream;");
            mv.visitLdcInsn("Subtracting floats:");  
            mv.visitMethodInsn(Opcodes.INVOKEVIRTUAL, "java/io/PrintStream", "println", "(Ljava/lang/String;)V", false); 
            mv.visitMethodInsn(Opcodes.INVOKESTATIC, "program2", "subtractFloat", "()V", false);
           
            mv.visitFieldInsn(Opcodes.GETSTATIC, "java/lang/System", "out", "Ljava/io/PrintStream;");
            mv.visitLdcInsn("Subtracting integers:");
            mv.visitMethodInsn(Opcodes.INVOKEVIRTUAL, "java/io/PrintStream", "println", "(Ljava/lang/String;)V", false);
            mv.visitMethodInsn(Opcodes.INVOKESTATIC, "program2", "subtractInteger", "()V", false);
